...
export const continueWithGithubSuccess = createAction(
  '[Auth] Continue With Github Success',
  props<{ user: User }>()
);
export const continueWithGithubFailure = createAction(
  '[Auth] Continue With Github Failure',
  props<{ error: any }>()
);
